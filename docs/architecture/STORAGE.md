...
| `views/make-money/v1/_evidence-corrections/<entity_id>.json` | Exact original/corrected bundle references and evidence-only consumer correction, applied by list/detail readers even if a legacy projector rewrites the ordinary entity view | CAS-protected rebuildable correction control; canonical originals unchanged |
