...
### 2. 収集対象：現実に金が動いていれば、地味・堅実・ハック・死因問わず全量拾う
...
### 3. 避けるべき「しょうもないやつ」の唯一の定義（何を集めてはいけないか）
落とすべきなのは「地味な商売」ではない。**「現実に客がおらず、金が1円も動いていない実態ゼロのゴミ」** だけである：
- × **集めてはならないゴミ**: 昨日ローンチしたアクセスゼロの個人開発、売上$0の実験場、実態のない月数千円のアフィリエイトブログ。
- ○ **拾うべき商売**: 現実に顧客が存在し、売上や利益が出ている（または実際に金が動いて資金が尽きて死んだ）実在のビジネスであれば、地味だろうが派手だろうが100%全量拾い上げよ。
