...
5. **ゼロ足切り ＆ 欠損誠実受入原則（手堅い商売の全量受入 ＆ 実態ゼロのゴミ排除）**:
   - **避けるべき「ゴミ」の唯一の定義**: 落とすべきなのは「地味な商売」ではない。**「現実に客がおらず、金が1円も動いていない実態ゼロの架空プロジェクト・アクセスゼロの実験場（昨日ローンチした売上$0の個人開発等）」のみを排除**せよ。
   - **手堅い商売の全量拾い上げ（ズルの有無による足切り禁止）**: 派手な裏技やズルがなくても、「地元の工場を地道に回ってリピート率95%で営業利益30%抜いている配管清掃会社」「ニッチな業界の帳票ツールを一人で10年メンテして月商300万をほぼ利益にしている個人SaaS」「職人技術や特許、立地で競合を無力化している町工場」等、**現実に利益が出ている手堅い構造は100%全量拾い上げよ**。
