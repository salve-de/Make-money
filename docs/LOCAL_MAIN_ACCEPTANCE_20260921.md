...
- Awaiting one consolidated manifest/API comparison for all 40 targets
- `l12` / `m13`: null-representation collision review
- `k11`: reprocessing quality/evidence collision review
