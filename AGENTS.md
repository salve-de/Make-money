...
- **マルチチャット並列自走規律（排他予約 ＆ 隔離保存）**:
  ...
  - ③ **手堅い商売の全量受入 ＆ 避けるべきゴミの境界**: 派手なズルがなくても現実に利益が出ている手堅い商売（リピート清掃、町工場、個人SaaS等）は100%全量拾う。落とすべきは「売上$0の実験場、月数千円のお小遣い稼ぎ、趣味ブログ、学生の工作など事業実体のないノイズ」のみ。個人なら飯が食えている規模（月商数十万〜100万円以上）、企業なら事業として自立している実体を柔軟に拾い上げよ。
