        ...
        <section className="space-y-4">
          ...
          <div className="p-4 sm:p-5 rounded-lg bg-[#12141A] border border-white/[0.08] space-y-3 font-sans shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1 font-sans text-xs">
              <div className="p-3 rounded bg-[#0B0C0E] border border-white/5 space-y-1">
                <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">ターゲット顧客</span>
              ...
              <div className="p-3 rounded bg-[#0B0C0E] border border-white/5 space-y-1">
                <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">提供する中核価値</span>
                <p className="text-zinc-200 font-medium leading-relaxed">
                  {company.businessEssence?.valueProposition || company.tagline}
                </p>
              </div>
              ...
              <div className="p-3 rounded bg-[#0B0C0E] border border-white/5 space-y-1">
                <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">収益化の仕組み</span>
                <p className="text-zinc-200 font-medium leading-relaxed">
