...
export const KNOWN_INGEST_BATCHES: IngestBatch[] = [
  {
    id: 'Primary_MUBS_1000',
    name: '一次情報検証 Primary/MUBS (755社)',
    shortLabel: 'Primary検証 (755社)',
    date: '2026-09-16',
    description: '一次情報スナップショット・MUBS検証に基づく高信頼・高収益実在企業755社',
  },
  {
    id: 'IndieHackers_Verified_1000',
    name: 'IndieHackers 公認検証勝者 (991社)',
    shortLabel: 'IndieHackers (991社)',
    date: '2026-09-16',
    description: 'IndieHackers公式プロダクト検証・ストライプ連携ログに基づく実在ソロプレナー991社',
  },
  {
    id: 'IndieHackers_new100t',
    name: '新着ソロプレナー Batch-T (100社)',
    shortLabel: '新着ソロ T (100社)',
    date: '2026-09-16',
    description: '2026年最新検証の小資本・一人型高収益サービス100社',
  },
  {
    id: 'IndieHackers_new100u',
    name: '新着ソロプレナー Batch-U (100社)',
    shortLabel: '新着ソロ U (100社)',
    date: '2026-09-16',
    description: '最新AIツール・自動化オペレーションを駆使した個人開発勝者100社',
  },
  {
    id: 'IndieHackers_new100v',
    name: '新着ソロプレナー Batch-V (100社)',
    shortLabel: '新着ソロ V (100社)',
    date: '2026-09-16',
    description: '受託脱却・ストック収益化したマイクロSaaS勝者100社',
  },
  {
    id: 'IndieHackers_new100w',
    name: '新着ソロプレナー Batch-W (100社)',
    shortLabel: '新着ソロ W (100社)',
    date: '2026-09-16',
    description: 'ニッチ市場を独占した小規模高利益率ビジネス100社',
  },
  {
    id: 'batch_analyst100_20260916',
    name: 'アナリスト特選 100選 (100社)',
    shortLabel: 'アナリスト特選 (100社)',
    date: '2026-09-16',
    description: '金融端末基準の一次財務ログに基づくアナリスト精選100社',
  },
  {
    id: 'batch_analyst_100_instantly_to_streak',
    name: '急成長ストリーク 100選 (99社)',
    shortLabel: '成長ストリーク (99社)',
    date: '2026-09-16',
    description: '初期MVPから爆発的トラクションを記録したSaaS勝者99社',
  },
  {
    id: 'batch_clean_winners_100_20260916',
    name: '実力派クリーン勝者 (92社)',
    shortLabel: 'クリーン勝者 (92社)',
    date: '2026-09-16',
    description: '固定費ゼロ・筋肉質損益分岐点を維持する実力派92社',
  },
  {
    id: 'batch_solo_winners_100_20260916',
    name: 'ソロ勝者特選 (88社)',
    shortLabel: 'ソロ勝者特選 (88社)',
    date: '2026-09-16',
    description: '完全1人運用で高粗利を抜くソロプレナー特選88社',
  },
  {
    id: 'batch_solo_winners_20260916',
    name: 'ソロ勝者アーカイブ (96社)',
    shortLabel: 'ソロ勝者 (96社)',
    date: '2026-09-16',
    description: '一人起業・キャッシュフロー先行型モデル96社',
  },
  {
    id: 'batch_analyst_20260916_exact100',
    name: 'アナリスト厳選 (80社)',
    shortLabel: 'アナリスト厳選 (80社)',
    date: '2026-09-16',
    description: '事業DNA・攻略設計図を完備したアナリスト精査80社',
  },
  {
    id: 'eBizFacts_Playbooks_1000',
    name: 'eBizFacts 事例プレイブック (17社)',
    shortLabel: 'eBiz事例 (17社)',
    date: '2026-09-16',
    description: '客観インタビューに基づく実在ビジネスモデル17社',
  },
  {
    id: 'batch-06-2026-09-15-codex-bootstrap100',
    name: '第6期 Codex AIブートストラップ (102社)',
    shortLabel: '第6期 (Codex AI)',
    date: '2026-09-15',
    description: 'Codex収集のAIブートストラップ・マイクロSaaS・高速自走勝者102社（BoltAI, Inkdrop, Memberstack, Typebot等）',
  },
  {
