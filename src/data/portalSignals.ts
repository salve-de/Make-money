...
export const PORTAL_SIGNALS: SignalDetailItem[] = [
  {
    ...
    catchphrase: '顔も声も出さず、手元15秒動画を量産して広告費0円で初月月利300万円を抜く手口',
  ...
  },
  {
    ...
    badge: 'MARKET SIGNAL 03 / ストック型不労所得',
    demandMetric: '継続課金 LTV特大',
    competitionMetric: '解約率 1%未満',
    title: '海外オープンソースSaaSの日本語化・国内代理導入',
    catchphrase: '英語圏の神OSSを日本語に翻訳してローカル中小企業へ導入。月3万円の保守契約で解約ゼロ',
    summary: 'GitHubで世界的に大流行しているオープンソース業務ツール（ERP、CRM、チャットサポートボット）を日本語化し、中小企業向けに月額3万円の保守契約で導入。自社開発ゼロで即座に毎月150万円以上の継続不労所得を築く手法。',
    estimatedCapital: '0円',
