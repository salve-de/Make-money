...
export const BUSINESS_DATA: BusinessItem[] = [
  ...
  },
  {
    ...
    proSecretInsight: '【特別会員限定・解錠済】イースロ氏の真の勝因は「SEOとPinterestの自動化」。Xのバズだけでなく、一度作ったテンプレートの使い方記事を自社ブログとPinterestにピン留めし、放置状態で毎月10万人の購買意欲の高い検索ユーザーが流入する不労導線を完成させている。',
    featured: true,
