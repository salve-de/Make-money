...
export function toTinyRecord(
  ...
  return {
    ...
    teamSize: entity.operations?.isTeamSizeUnconfirmed ? null : (entity.operations?.teamSize ?? null),
    monthlyRevenue: entity.pnl?.isRevenueUnconfirmed ? null : (entity.pnl?.monthlyRevenue ?? null),
    operatingMargin: entity.pnl?.isMarginUnconfirmed ? null : (entity.pnl?.operatingMargin ?? null),
    growthRateYoY: entity.isGrowthUnconfirmed ? null : (entity.growthRateYoY ?? null),
