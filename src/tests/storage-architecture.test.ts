...
import { checkMigrationOrder, checkStorageImports, checkStorageResources } from '../../scripts/architecture/check-storage.mjs';
const production = {
  name: 'make-money-app', vars: { ENVIRONMENT: 'production' },
