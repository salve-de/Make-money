...
export const INSTITUTIONAL_ENTITIES: FinancialEntity[] = [
  ...
  },
  {
    ...
    tags: ['水門番', '取引通行税', 'API経済', '開発者特化', '決済インフラ', 'スイッチングコスト大'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 150000000000, // 月商約1,500億円 (年商約1.8兆円)
      cogs: 97500000000, // Visa/Mastercardへのインターチェンジ手数料 (約65%)
    ...
    operations: {
      ...
      automationLevel: 94,
      primaryChannels: ['エンジニアの自発的口コミ（開発者第一主義）', 'Y Combinator・VCネットワーク', 'Stripe Atlas起業パッケージ'],
      toolStack: [
        { name: 'AWS & 分散データセンター', category: 'インフラ', monthlyCost: 4000000000, purpose: '全世界数百万件の同時決済トランザクションのミリ秒処理と稼働率99.999%保証', replacementDifficulty: 'HIGH' },
        { name: '内製不正検知AI (Stripe Radar)', category: 'セキュリティ', monthlyCost: 1500000000, purpose: '数十億件のグローバル決済データから不正カード利用をミリ秒判定・自動遮断', replacementDifficulty: 'HIGH' },
      ],
    },
    strategy: {
  ...
  },
  {
    ...
    tags: ['完全1人', 'ボイラープレート', '買い切り型', '原価ゼロ', 'Xバイラル', '利益率90%超'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 8500000, // 月商約850万円 ($55,000)
      cogs: 250000, // Stripe/LemonSqueezy決済手数料 (約3%)
      grossProfit: 8250000,
      grossMargin: 97.0,
      operatingExpenses: {
        serverAndApi: 35000, // Vercel Pro, Supabase
        advertising: 0, // 広告費完全0円
        subcontracting: 0, // 従業員・外注完全0人
        toolsAndSaaS: 65000, // Resend, Typeform
        other: 50000,
      },
      operatingProfit: 8100000, // 営業利益 (手残り月810万円)
      operatingMargin: 95.3,
      estimatedAnnualNetProfit: 97200000, // 年間純利約1億円
    },
    operations: {
      teamSize: 1,
      weeklyHours: 10,
      ...
      automationLevel: 98,
      primaryChannels: ['X（Twitter）Build in Public動画発信', 'Product Huntローンチ', '個人開発者コミュニティ'],
      toolStack: [
        { name: 'Next.js + Tailwind CSS', category: 'フロントエンド', monthlyCost: 0, purpose: '購入者が即座に改変できるモダンなUIフレームワーク', replacementDifficulty: 'HIGH', url: 'https://nextjs.org' },
        { name: 'Stripe & Lemon Squeezy', category: '決済', monthlyCost: 0, purpose: 'グローバルからの買い切り決済とMoR（税務自動処理）', replacementDifficulty: 'LOW', url: 'https://lemonsqueezy.com' },
        { name: 'Vercel', category: 'ホスティング', monthlyCost: 3000, purpose: 'LPのグローバル超高速エッジ配信', replacementDifficulty: 'LOW', url: 'https://vercel.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['Habit Trackerアプリ (月数千円で爆死)', 'AIチャットボット (競合乱立で埋没)', '複数マイクロツール (鳴かず飛ばず)'],
  ...
  },
  {
    ...
    tags: ['完全1人', 'API包装', '粗利80%超', 'B2C', 'ノーフレームワーク', '自撮り特化'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 13000000, // 月商約1,300万円 ($85,000)
      cogs: 2600000, // Replicate/RunPodのGPU推論コスト (約20%)
      grossProfit: 10400000,
      grossMargin: 80.0,
      operatingExpenses: {
        serverAndApi: 150000, // Hetzner専用サーバー (約1,000ドル以下)
        advertising: 0, // 広告費完全0円
        subcontracting: 0, // 従業員・外注完全0人
        toolsAndSaaS: 120000, // Postmark, Sentry
        other: 80000,
      },
      operatingProfit: 10050000, // 営業利益 (手残り月1,000万円超)
      operatingMargin: 77.3,
      estimatedAnnualNetProfit: 120600000, // 年間純利約1.2億円
    },
    operations: {
      teamSize: 1,
      weeklyHours: 10,
      ...
      automationLevel: 98,
      primaryChannels: ['X（Twitter）バイラル投稿', 'オーガニック検索 (SEO)', '口コミ・バイラルループ'],
      toolStack: [
        { name: 'Replicate / RunPod API', category: 'GPU推論', monthlyCost: 2600000, purpose: 'ユーザーがアップした写真からLoRAモデルをオンデマンド学習・高速生成', replacementDifficulty: 'LOW', url: 'https://replicate.com' },
        { name: 'Hetzner ベアメタルサーバー', category: 'インフラ', monthlyCost: 45000, purpose: '月額数十万円のAWSを避け、月額数万円の専用サーバー1台で全トラフィックを処理', replacementDifficulty: 'HIGH', url: 'https://hetzner.com' },
        { name: 'Vanilla JS + PHP + SQLite', category: '開発言語', monthlyCost: 0, purpose: 'ReactやNext.jsを一切使わず、プレーンなPHPとSQLiteのみで極限のシンプル運用', replacementDifficulty: 'HIGH' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['Avatar AI (単発買い切りのため売上が急減)', '複数プロトタイプ'],
  ...
  },
  {
    ...
    tags: ['完全1人', 'コミュニティ課金', 'クラウドソース', '高粗利', 'ライフタイム課金', 'SEO要塞'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 37500000, // 月商約3,750万円 ($250,000)
      cogs: 1100000, // Stripe決済手数料 (約3%)
      grossProfit: 36400000,
      grossMargin: 97.0,
      operatingExpenses: {
        serverAndApi: 150000, // Hetznerサーバー複数台
        advertising: 0, // 広告費完全0円
        subcontracting: 0, // 従業員ゼロ
        toolsAndSaaS: 250000, // 外部API・通知
        other: 100000,
      },
      operatingProfit: 35900000, // 営業利益 (手残り月3,500万円超)
      operatingMargin: 95.7,
      estimatedAnnualNetProfit: 430800000, // 年間純利約4.3億円
    },
    operations: {
      teamSize: 1,
      weeklyHours: 5,
      initialCapitalRequired: 0,
      automationLevel: 99,
      primaryChannels: ['全世界の都市データSEO（数万ページの自動生成）', 'X（Twitter）コミュニティ', 'ノマド界隈の自然バイラル'],
      toolStack: [
        { name: 'Vanilla PHP + SQLite', category: 'バックエンド', monthlyCost: 0, purpose: '何十万件の都市データとユーザープロファイルを超軽量DBで高速処理', replacementDifficulty: 'HIGH' },
        { name: 'Hetzner Dedicated Server', category: 'サーバー', monthlyCost: 60000, purpose: 'AWSの数十倍安価な物理サーバーで世界中からのアクセスを処理', replacementDifficulty: 'HIGH', url: 'https://hetzner.com' },
        { name: 'Stripe Checkout', category: '決済', monthlyCost: 0, purpose: 'グローバル通貨での即時買い切り決済', replacementDifficulty: 'LOW', url: 'https://stripe.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['Tubelytics (1年かけて失敗)', 'GIFbook (極小マージン)', 'PlayMyInbox (マネタイズ不能)', 'Go Fucking Do It'],
  ...
  },
  {
    ...
    tags: ['プライバシー保護', 'オープンソース', 'GDPR特化', '小規模チーム', '脱Google', 'クッキーレス'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 18000000, // 月商約1,800万円 ($120,000)
      cogs: 540000, // Stripe決済手数料 (約3%)
      grossProfit: 17460000,
      grossMargin: 97.0,
      operatingExpenses: {
        serverAndApi: 1500000, // ClickHouse高速サーバー群 (Hetzner)
        advertising: 0, // 広告費0円
        subcontracting: 0, // 外注ゼロ
        toolsAndSaaS: 350000, // 開発・メールツール
        other: 2500000, // 創業者2名＋少人数スタッフの生活費・給与
      },
      operatingProfit: 13110000, // 営業利益 (手残り月1,300万円超)
      operatingMargin: 72.8,
      estimatedAnnualNetProfit: 157320000, // 年間純利約1.5億円
    },
    operations: {
      teamSize: 4,
      weeklyHours: 30,
      ...
      automationLevel: 95,
      primaryChannels: ['コンテンツマーケティング（脱Google訴求ブログ）', 'Hacker News / Redditでのオーガニックバズ', 'オープンソースGitHubリポジトリ'],
      toolStack: [
        { name: 'Elixir + Phoenix Framework', category: 'バックエンド', monthlyCost: 0, purpose: '秒間数万件のアクセスログを最小限のサーバー負荷で超並行処理', replacementDifficulty: 'HIGH' },
        { name: 'ClickHouse', category: '列指向DB', monthlyCost: 800000, purpose: '数十億レコードの分析クエリを1秒未満で返す超高速集計エンジン', replacementDifficulty: 'HIGH', url: 'https://clickhouse.com' },
        { name: 'Hetzner クラウド/ベアメタル', category: 'インフラ', monthlyCost: 700000, purpose: 'EU圏内のデータ主権を守りつつ低コストで大容量トラフィックをホスト', replacementDifficulty: 'MEDIUM', url: 'https://hetzner.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['初期の単なるシンプル解析 (月商数十ドルで撃沈)', '無料プランの提供 (成長鈍化の原因となり廃止)'],
  ...
  },
  {
    ...
    tags: ['クッキーレス', 'プライバシー保護', 'GA4代替', 'マイクロSaaS', 'HackerNews発', '完全ブートストラップ'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 7600000, // 月商約760万円 ($50,700)
      cogs: 380000, // Stripe決済手数料 (約$1,865 = 約28万円) ＋ インフラ原価
      grossProfit: 7220000,
      grossMargin: 95.0,
      operatingExpenses: {
        serverAndApi: 350000, // Cloudflare, Hetzner, AWS
        advertising: 150000, // 広告費ほぼゼロ（SEOとブログ）
        subcontracting: 0,
        toolsAndSaaS: 200000, // カスタマーサポート・メール
        other: 500000, // オランダ法人維持費・法務
      },
      operatingProfit: 6020000, // 営業利益 (手残り月600万円超)
      operatingMargin: 79.2,
      estimatedAnnualNetProfit: 72240000, // 年間純利約7,200万円
    },
    operations: {
      teamSize: 2,
      weeklyHours: 25,
      ...
      automationLevel: 94,
      primaryChannels: ['Hacker Newsコミュニティ', 'Googleオーガニック検索', '開発者による社内推奨・リファラル'],
      toolStack: [
        { name: 'Node.js + PostgreSQL', category: 'バックエンド', monthlyCost: 150000, purpose: 'クッキーを生成せずIPアドレスをハッシュ化して破棄する集計基盤', replacementDifficulty: 'HIGH' },
        { name: 'Cloudflare Workers & CDN', category: 'エッジ配信', monthlyCost: 50000, purpose: '全世界からの解析ビーカーをミリ秒で受信・エッジ集約', replacementDifficulty: 'MEDIUM', url: 'https://cloudflare.com' },
        { name: 'Stripe Billing', category: '決済', monthlyCost: 280000, purpose: 'グローバル開発者からの月額・年額サブスクリプション自動回収', replacementDifficulty: 'LOW', url: 'https://stripe.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['インターンシップ仲介プラットフォーム (需要読み違いで失敗)', '初期の有償オンボーディングのみの試行'],
  ...
  },
  {
    ...
    tags: ['ポッドキャスト', '音声配信', '無制限番組', 'RSSロックイン', 'マイクロSaaS', '2人開発'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 18000000, // 月商約1,800万円 ($120,000)
      cogs: 900000, // Stripe決済手数料 (約$3,500) ＋ 音声ファイルCDN帯域費 (約$2,500)
      grossProfit: 17100000,
      grossMargin: 95.0,
      operatingExpenses: {
        serverAndApi: 750000, // AWS S3, CloudFront, Heroku
        advertising: 300000, // ポッドキャストスポンサー・業界イベント
        subcontracting: 450000, // パートタイムカスタマーサポート
        toolsAndSaaS: 300000, // Rewardful, Intercom, HelpScout
        other: 400000, // 会計・法務・税務
      },
      operatingProfit: 14900000, // 営業利益 (手残り月1,400万円超)
      operatingMargin: 82.8,
      estimatedAnnualNetProfit: 178800000, // 年間純利約1.8億円
    },
    operations: {
      teamSize: 2,
      weeklyHours: 20,
      ...
      automationLevel: 95,
      primaryChannels: ['ポッドキャスター同士の口コミ', 'Rewardful成果報酬アフィリエイト', 'Apple/Spotifyディレクトリ経由の露出'],
      toolStack: [
        { name: 'Ruby on Rails + Heroku', category: 'バックエンド', monthlyCost: 250000, purpose: '高信頼性のWebアプリケーションとRSSフィード高速生成基盤', replacementDifficulty: 'HIGH' },
        { name: 'AWS S3 + CloudFront (CDN)', category: 'ストレージ/配信', monthlyCost: 500000, purpose: '世界中からのギガバイト単位の音声ファイルダウンロードをミリ秒配信', replacementDifficulty: 'HIGH', url: 'https://aws.amazon.com' },
        { name: 'Rewardful (アフィリエイト管理)', category: 'グロース配管', monthlyCost: 50000, purpose: '有力ポッドキャスターへの25%生涯手数料の自動計算・送金', replacementDifficulty: 'LOW', url: 'https://rewardful.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['Jon Budaの初期Simplecastでの葛藤', 'Justinの過去の複数単発Webサービスの停滞'],
  ...
  },
  {
    ...
    tags: ['Link-in-bio', 'クリエイターエコノミー', '完全1人開発', 'ゲリラDM営業', 'マイクロSaaS'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 3800000, // 月商約380万円 ($25,000)
      cogs: 310000, // Stripe決済手数料 (約$2,038 = 約30万円、低単価多数決済のため$0.30固定費が重い)
      grossProfit: 3490000,
      grossMargin: 91.8,
      operatingExpenses: {
        serverAndApi: 150000, // Vercel, Supabase
        advertising: 200000, // Instagram Ads, Google Ads
        subcontracting: 0, // 完全1人運営
        toolsAndSaaS: 100000, // SendGrid, Intercom
        other: 150000, // サーバー維持費等
      },
      operatingProfit: 2890000, // 営業利益 (手残り月280万円超)
      operatingMargin: 76.0,
      estimatedAnnualNetProfit: 34680000, // 年間純利約3,400万円
    },
    operations: {
      teamSize: 1,
      weeklyHours: 15,
      initialCapitalRequired: 50000,
      automationLevel: 96,
      primaryChannels: ['「Made with Liinks」バイラルバッジ', 'InstagramコールドDMゲリラ営業', 'Instagram/Google広告'],
      toolStack: [
        { name: 'React + Next.js + Tailwind', category: 'フロントエンド', monthlyCost: 30000, purpose: 'モバイルファーストの高速ページレンダリング', replacementDifficulty: 'HIGH' },
        { name: 'Supabase (PostgreSQL)', category: 'データベース', monthlyCost: 50000, purpose: 'ユーザーのリンク設定と画像URLの高速配信', replacementDifficulty: 'MEDIUM', url: 'https://supabase.com' },
        { name: 'Stripe Checkout', category: '決済', monthlyCost: 300000, purpose: '低単価（月$4〜$8）の大量グローバルマイクロ課金処理', replacementDifficulty: 'LOW', url: 'https://stripe.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['Colors of Motion (収益化できず)', 'VSUAL (GMV6桁ドルも薄利で破綻)', 'パンデミックでのサラリーマン戻り'],
  ...
  },
  {
    ...
    tags: ['SNS予約', '透明性経営', '給与公開', '完全リモート', '自己資本重視', '年商30億'],
    essence: {
    ...
    pnl: {
      monthlyRevenue: 260000000, // 月商約2.6億円 ($1.75M)
      cogs: 13000000, // Stripe決済手数料 (約2.9% = 約750万円) ＋ クラウドインフラ原価 (約550万円)
      grossProfit: 247000000,
      grossMargin: 95.0,
      operatingExpenses: {
        serverAndApi: 20000000, // AWS, MongoDB, Redis, OpenAI API
        advertising: 8000000, // コンテンツマーケ・ブランド広告
        subcontracting: 5000000, // 外部ライター・法務
        toolsAndSaaS: 12000000, // Slack, GitHub, Zoom, Datadog等
        other: 150000000, // 全社リモート社員約80名の給与・社会保険（完全公開）
      },
      operatingProfit: 52000000, // 営業利益 (月約5,200万円、利益率20%)
      operatingMargin: 20.0,
      estimatedAnnualNetProfit: 520000000, // 年間純利約5.2億円
    },
    operations: {
      teamSize: 80,
      weeklyHours: 32, // 週4日勤務制を導入
      initialCapitalRequired: 0,
      automationLevel: 88,
      primaryChannels: ['Open Blog（財務・給与公開による圧倒的SEO・被リンク）', 'フリーミアムからのアップセル', 'SNS界隈の自然バイラル'],
      toolStack: [
        { name: 'AWS クラウドインフラ', category: 'インフラ', monthlyCost: 15000000, purpose: '月間数千万件のSNS投稿キューをミリ秒精度でスケジュール配信', replacementDifficulty: 'HIGH', url: 'https://aws.amazon.com' },
        { name: 'X / Meta / LinkedIn 公式API', category: '外部連携', monthlyCost: 3500000, purpose: '各巨大プラットフォームへの公認投稿プロトコル接続', replacementDifficulty: 'HIGH' },
        { name: 'Stripe Billing & Invoicing', category: '決済', monthlyCost: 7500000, purpose: '世界中14万件以上の有料サブスクリプション決済処理', replacementDifficulty: 'HIGH', url: 'https://stripe.com' },
      ],
    },
    strategy: {
    ...
    dynamicMoats: {
      ...
      pivotGraveyard: {
        failedAttempts: ['コードを書かずに公開した2ページの煙幕テストLP', '初期のTwitter限定機能の限界'],
  ...
  },
  {
    ...
    tags: ['完全1人', '原価ゼロ', 'Notionテンプレ', 'Gumroad', 'デジタル商品', '利益率95%超'],
    essence: {
    ...
    operations: {
      ...
      initialCapitalRequired: 0,
      automationLevel: 98,
      primaryChannels: ['X（Twitter）でのミニマルデザイン画像投稿', 'Product Huntローンチ', 'Gumroadストアフロント'],
      toolStack: [
        { name: 'Notion', category: '制作基盤', monthlyCost: 1500, purpose: 'テンプレートの設計・複製リンクの発行', replacementDifficulty: 'HIGH', url: 'https://notion.so' },
        { name: 'Gumroad / Lemon Squeezy', category: '決済・配信', monthlyCost: 0, purpose: 'デジタル成果物の決済と自動ダウンロードリンク送付', replacementDifficulty: 'LOW', url: 'https://gumroad.com' },
        { name: 'ConvertKit (Kit)', category: 'メルマガ', monthlyCost: 15000, purpose: '無料配布で獲得した数万人のリストへの新作テンプレ自動案内', replacementDifficulty: 'LOW', url: 'https://kit.com' },
      ],
    },
    strategy: {
