...
export const MONEY_FLOW_TRENDS: MoneyFlowTrend[] = [
  ...
  {
    id: 'trend_privacy_counter',
    badge: '急上昇 +290%',
    title: 'Google GA4の改悪・クッキーバナーの怨嗟逆手！超軽量プライバシー解析の2人開発要塞',
    growthRateYoY: 290,
    avgMargin: 88,
    summary: 'EUのGDPR罰則恐怖とGA4の複雑怪奇なUIに疲弊したWebマスターを突いて、月額$9〜$99のクッキーレス解析で月商数百万円・利益率80%超を抜く型。',
    structuralBackground: 'Googleは広告追跡ビジネスモデル上、クッキー撤廃やデータ非保持に舵を切れない。この大手の自縛バグを突き、1行タグを貼るだけで同意バナーを消滅させる超軽量ツールを提供し、Hacker News経由で初動を総取りする。',
    targetPainWallet: 'クッキー同意バナーによる直帰率悪化とGA4の移行に苦しむWeb担当者・エンジニア（コンプライアンスの財布）',
    representativeEntityIds: ['ent_simpleanalytics', 'ent_plausible'],
    timestamp: '2026.Q1',
  },
  {
