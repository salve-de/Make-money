...
> 人数・粗利率・営業利益・ツール・URL・創業者など、**必要なデータは当然すべて徹底調査し、全量収集して記録する**。しかし、**いかなる数値や項目の有無も【収集の足切り条件（フィルター）】には絶対にしない**。粗利の多寡、人数の大小、URLの有無に囚われず、金が動いている生々しい事実と手口（裏帳簿）があれば柔軟に全て拾い上げよ。
