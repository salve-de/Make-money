...
> 
> ### 【4大鉄則（街灯効果の粉砕 ＆ 収集と足切りの完全分離）】
> 1. **街灯効果の粉砕**: Web上で拾いやすいSaaS（街灯の下）ばかり探すな。暗闇（下請け、物販、オフライン、店舗、匿名、大爆死検死）にこそ富の鍵が落ちている。
> 2. **プロクラステスのベッドの粉砕**: 粗利80%や1人などの勝手な枠で現実の手足を切り落とすな。
> 3. **収集項目と足切り条件の完全分離**: 人数・粗利・原価・URL・創業者・ツールは**すべて徹底調査して記録するが、いかなる項目や数値も【収集の足切り条件】には絶対にしない**。
> 4. **外れ値（ファットテール）の独占**: 資本主義のアルファは特異点の裏帳簿にのみ宿る。
> 
