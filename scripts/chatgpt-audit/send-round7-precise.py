...
def main():
    print("1. Bringing Safari window to front...")
    script_raise = '''
    ...
    print("2. Focusing text area directly (pos: 993, 752)...")
    click(993, 752)
    time.sleep(0.4)

    # Set value directly or paste
    print("3. Setting text via clipboard and paste...")
    ...
    print("Successfully sent prompt to ChatGPT!")
