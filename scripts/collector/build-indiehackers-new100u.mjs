...
const template = fs.readFileSync(templatePath, "utf8")
  .replaceAll("new100o", "new100u")
  .replaceAll("new100O", "new100U")
  .replaceAll("codex-20260916-ih-new100o", "codex-20260916-ih-new100u")
  .replaceAll(
  ...
  .replace(
    ...
    () => 'const raw = line.split(" [CLAIMED:")[0]; const head = raw.replace(/ — IHNEW100U$/, ""); const pivot = head.lastIndexOf(" — "); const name = pivot >= 0 ? head.slice(0, pivot) : head; const targetDomain = pivot >= 0 ? head.slice(pivot + 3) : "";',
  );
