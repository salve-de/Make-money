...
const AGENT_ID = "codex-20260916-ih-new100m";
const BATCH_ID = "batch-indie-hackers-new100m-20260916";
const CLAIMS_FILE = path.join(ROOT, "data/CLAIMED_TARGETS.txt");
const OUT_FILE = path.join(ROOT, "data/incoming/batch_indiehackers_new100m_20260916.json");
const SOURCE_FILE = path.join(ROOT, "data/incoming/batch_indiehackers_new100m_sources_20260916.json");
const RECEIPT_FILE = path.join(ROOT, "data/incoming/batch_indiehackers_new100m_official_checks_20260916.json");
